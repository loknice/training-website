...
- `GET /api/foxs` - отримати список всіх записів зайців
- `GET /api/foxs/:id` - отримати дані про зайця за ID
- `POST /api/foxs` - створити новий запис зайця
- `PUT /api/foxs/:id` - повністю оновити запис зайця за ID
- `PATCH /api/foxs/:id` - частково оновити запис зайця за ID
- `DELETE /api/foxs/:id` - видалити дані про зайця за ID
- `HEAD /api/foxs` - отримати метадані списку зайців
